                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="trending-news-item">
                                                <div class="trending-news-content">
                                                    ...
                                                    <h3 class="title"><a href="#">There may be no consoles in the future
                                                            ea exec says</a></h3>
                                                    <p class="text">The property, complete with 30-seat screening from
                                                        room, a 100-seat amphitheater and a swimming pond with sandy
                                                        shower…</p>
                                                    <a href="#">Read more</a>
                                                </div>
                                            </div>
                            ...
                            <div class="post_gallery_items">
                                <div class="gallery_item">
                                    ...
                                    <div class="gallery_item_content">
                                        ...
                                        <h4 class="title"><a href="#">Copa America: Luis Suarez from devastated US</a>
                                        </h4>
                                    </div>
                                </div>
                                <div class="gallery_item">
                                ...
                                <div class="gallery_item">
                                    ...
                                    <div class="gallery_item_content">
                                        ...
                                        <h4 class="title"><a href="#">U.S. Response subash says he will label regions by
                                                risk of…</a></h4>
                                    </div>
                                </div>
                                <div class="gallery_item">
                                    ...
                                    <div class="gallery_item_content">
                                        ...
                                        <h4 class="title"><a href="#">Venezuela elan govt and opposit the property
                                                collect</a></h4>
                                    </div>
                                </div>
                                <div class="gallery_item">
