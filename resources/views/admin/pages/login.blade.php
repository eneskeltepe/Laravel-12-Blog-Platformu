...
<head>
    <meta charset="utf-8" />
    <title>Blog Sitesi | Giriş Yap</title>
...
<body>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('admin.login.post') }}">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="username" class="form-label">E-Mail adresiniz</label>
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="auth-pass-reset-basic.html" class="text-muted">Şifrenizi mi
                                                    unuttunuz?</a>
                                            </div>
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" name="password"
                                                    ...
                                                    placeholder="Şifrenizi girin" id="password-input" />
                                                <button
    ...
    <!-- particles js -->
    <script src="{{ asset('assetsAdmin/libs/particles.js/particles.js') }}"></script>
    <!-- particles app js -->
    <script src="{{ asset('assetsAdmin/js/pages/particles.app.js') }}"></script>
    <!-- password-addon init -->
    <script src="{{ asset('assetsAdmin/js/pages/password-addon.init.js') }}"></script>
</body>
